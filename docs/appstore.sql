...
LOCK TABLES `app_downloads` WRITE;
/*!40000 ALTER TABLE `app_downloads` DISABLE KEYS */;
/*!40000 ALTER TABLE `app_downloads` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `apps` VALUES (1,'恶魔忍者2汉化版','http://cdn.image.market.hiapk.com/data/upload//2012/04_11/201204111029383871.png','1.1.7',0,14,'Droid Studio','English','10.5M',2352365,'2012-06-03 12:33:27',NULL,NULL,'upload/app/1.apk','恶魔忍者2 Devil Ninja2(vs Boss)<br/>
...
INSERT INTO `apps` VALUES (2,'腾讯微信','/upload/icon/201204111029383871.png','4.0',0,11,'中国腾讯科技（深圳）有限','中文','10.39MB',26492776,'2012-06-03 12:33:27',NULL,NULL,'upload/app/2.apk','基于Android平台的腾讯微信服务，带给您全新的移动即时通信体验。您可以使用微信软件快速地发送消息，即时拍照分享，随时随地联系身边的朋友。支持基于Android平台的手机终端设备。为了保护您的隐私，微信不会自动扫描和上传您的手机通讯录。并且不透露信息是否已读，降低收信压力。功能简介： 1.快速消息：极速轻快的楼层式消息对话，带给您飞一般的手机聊天体验。 2.照片分享：可调用手机拍照或插入相册图片,照片任意发，只需支付流量费用。 3.设置头像：给自己设置个性化头像,让您在好友的微信里看起来更亲切。');

INSERT INTO `apps` VALUES (3,'腾讯微信','/upload/icon/201204111029383871.png','3.0',0,10,'中国腾讯科技（深圳）有限','中文','10.39MB',26492776,'2012-06-03 12:33:27',NULL,NULL,'upload/app/2.apk','基于Android平台的腾讯微信服务，带给您全新的移动即时通信体验。您可以使用微信软件快速地发送消息，即时拍照分享，随时随地联系身边的朋友。支持基于Android平台的手机终端设备。为了保护您的隐私，微信不会自动扫描和上传您的手机通讯录。并且不透露信息是否已读，降低收信压力。功能简介： 1.快速消息：极速轻快的楼层式消息对话，带给您飞一般的手机聊天体验。 2.照片分享：可调用手机拍照或插入相册图片,照片任意发，只需支付流量费用。 3.设置头像：给自己设置个性化头像,让您在好友的微信里看起来更亲切。');
...
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(1, '专题', 0, 0, now());
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(2, '应用', 0, 0, now());
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(3, '游戏', 0, 0, now());
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(10, '通讯.聊天', 2, 509325, now());
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(11, '装机必备', 1, 23425, now());
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(12, '照片美化工具箱', 1, 13532, now());
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(13, '学习好帮手', 3, 5326, now());
INSERT INTO categories(id, name, parent_id, app_count, created_at)
VALUES(14, '声控游戏', 2, 867962, now());
